...
class OrderChart extends Component {
  ...
  fetchData = () => {
    ...
    const completedUrl = `http://localhost:5167/api/orders/management/orders/completed?startDate=${startDate}&endDate=${endDate}`;
    const pendingUrl = `http://localhost:5167/api/orders/management/orders/pending?startDate=${startDate}&endDate=${endDate}`;
